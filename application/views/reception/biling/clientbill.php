...
<div class="panel panel-default">
    ...
    <p align="center"><a href="http://192.168.100.2/wellness/dashboard/printReciept/<?php echo $client->clientnumber;?>/<?php echo $client->checkupdate;?>" class="btn btn-lg btn-success">Print Reciept</a></p>
    </div>
<!-- /.panel -->