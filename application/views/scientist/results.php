  ...
  <div id="tab-content-results" class="tab-content">
     ...
     <div class="tab-pane" id="comments">
      <form id="drAssesment" name="comments">
          ...
          <a href="<?php echo base_url('dashboard/printThis/'.$client->names.'_'.$client->surname.'_'.$client->clientnumber.'/'.$client->clientnumber.'/'.$client->date);?>" class="btn btn-lg btn-success">Print Out Report</a>
        </form>
     </div>
   </div>
  </div>
